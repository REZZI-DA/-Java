...
public class TargetController {
	...
	/**
	 * fügt dem gewählten Level ein neues Target hinzu
	 * 
	 * @param target
	 *            neues Ziel
	 * @param lvl
	...
	/**
	 * tauscht ein Target im Levelobjekt aus und persistiert die Änderungen
	 * 
	 * @param lvl
	 *            zu welchem Level das Target gehört
	 * @param target
	 *            das zu ändernde Target
	...
	public boolean updateTarget(Level lvl, Target target) {
		...
		// Target in der Persistenz ändern
		if (success) {
	...
	/**
	 * löscht ein Target aus dem Levelobjekt und persistiert die Änderungen
	 * 
	 * @param lvl
	 *            zu welchem Level das Target gehört
	 * @param target
	 *            das zu löschende Target
	 * @return true wenn das angegebene Target in der Liste gefunden wurde, false
	 *         wenn nicht
	 */
